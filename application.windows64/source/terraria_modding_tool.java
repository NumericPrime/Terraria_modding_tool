...
public class terraria_modding_tool extends PApplet {
...
boolean gun_=false;
boolean bow_=false;
public String parseBool(boolean p) {
  if (p==true) {
    return "true";
  } else {
    return "false";
...
public void setTooltip(String t) {
  ...
  static public void main(String[] passedArgs) {
    String[] appletArgs = new String[] { "--present", "--window-color=#1905FF", "--stop-color=#FF0000", "terraria_modding_tool" };
    if (passedArgs != null) {
